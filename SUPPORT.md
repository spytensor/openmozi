...
OpenMozi is a community-maintained open-source project. Support is best-effort and does not include service-level guarantees.
...
Provide the OpenMozi version or commit, affected surface, operating environment, deterministic reproduction steps, expected behavior, actual behavior, and sanitized evidence. Reports without enough evidence to reproduce the behavior may be closed until more information is available.
